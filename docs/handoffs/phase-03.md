...
| Profile | URDF joint | 协议索引 | URDF origin xyz / rpy | URDF local axis | 目标限位 (deg) |
|---|---|---:|---|---|---:|
| `j1` | `joint_1` | 0 | `0 0 0.087` / `0 0 0` | `0 0 1` | -179.91…179.91 |
| `j2` | `joint_2` | 1 | `0.035 0 0.0375` / `1.5708 0 -3.1416` | `0 0 1` | -74.48…124.90 |
| `j3` | `joint_3` | 2 | `0 0.146 0` / `0 0 1.5708` | `0 0 1` | -93.39…91.67 |
| `j4` | `joint_4` | 3 | `0.052 0 0` / `-1.5708 0 0` | `0 0 1` | -179.91…179.91 |
| `j5` | `joint_5` | 4 | `0 0 0.117` / `1.5708 0 0` | `0 0 1` | -100.84…100.84 |
| `j6` | `joint_6` | 5 | `0 0.0625 0` / `-1.5708 0 0` | `0 0 1` | -179.91…179.91 |

权威值仍来自 `shared/robot-profiles/BuiltIn/dummy-6dof/model/dummy.urdf` 与 `manifest.json`；表格是交接索引，不是新的配置源。URDF 的 effort/velocity 仍为零且未验证，未被推断为硬件动态上限。
