...
if ($capabilities.contractVersion -ne '1.2' -or $capabilities.commandPolicy -ne 'engineering' -or -not $capabilities.directCommand) {
    throw 'Gateway started without the required RobotGatewayV1.2 engineering direct capability.'
}
